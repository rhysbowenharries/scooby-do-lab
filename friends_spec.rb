...
class TestFriends < MiniTest::Test
  ...
  def test_does_so_and_so_like_such_and_such
  ...
  def test_add_friend
    result = add_friend(@person5, "Claude")
  ...
  def test_transfer_monies
    result = transfer_monies(@person5, @person1, 100)
#lender
...
#lendee
  ...
  def test_concatenate_food
    ...
    assert_equal(["bread", "charcuterie", "ratatouille", "Scooby snacks", "soup", "spaghetti", "spinach"], result)
  end
